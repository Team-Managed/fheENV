...
export function HeroDitheringContainer({
  ...
  return (
    <div
      className={cn(
        "max-w-7xl mx-auto px-6 relative z-10 grid gap-6 pb-16 sm:gap-8 sm:pb-20 lg:grid-cols-[1fr_minmax(300px,500px)] lg:items-center lg:gap-12 lg:pb-24 xl:grid-cols-[1fr_1fr]",
        className,
      )}
...
export function HeroDitheringContent({
  ...
  return (
    <div
      className={cn("flex flex-col justify-center gap-4 text-balance sm:gap-5 lg:gap-6", className)}
...
export function HeroDitheringVisual({
  ...
  return (
    ...
    >
      <div
        className={cn("absolute inset-0 flex items-center justify-center", desktopClassName)}
