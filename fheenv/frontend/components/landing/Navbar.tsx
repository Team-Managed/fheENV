  ...
  return (
    <nav className="flex items-center justify-between px-6 py-5 max-w-7xl mx-auto w-full z-50 relative">
      ...
      <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
        <Link href="#features" className="hover:text-aqua transition-colors">Features</Link>
        <Link href="#how-it-works" className="hover:text-aqua transition-colors">How it works</Link>
        <Link href="#faq" className="hover:text-aqua transition-colors">FAQ</Link>
      </div>
